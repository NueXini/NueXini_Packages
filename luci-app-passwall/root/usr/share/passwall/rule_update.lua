...
local gfwlist_url = ucic:get(name, "@global_rules[0]", "gfwlist_url") or {"https://cdn.jsdelivr.n$(TOPDIR)/feeds/packages/Loyalsoldier/v2ray-rules-dat@release/gfw.txt"}
...
local chnlist_url = ucic:get(name, "@global_rules[0]", "chnlist_url") or {"https://cdn.jsdelivr.n$(TOPDIR)/feeds/packages/felixonmars/dnsmasq-china-list/accelerated-domains.china.conf","https://cdn.jsdelivr.n$(TOPDIR)/feeds/packages/felixonmars/dnsmasq-china-list/apple.china.conf","https://cdn.jsdelivr.n$(TOPDIR)/feeds/packages/felixonmars/dnsmasq-china-list/google.china.conf"}
