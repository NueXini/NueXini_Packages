...
o:value("https://cdn.jsdelivr.n$(TOPDIR)/feeds/packages/small-5/ad-rules/adguard","AdGuard")
o:value("https://cdn.jsdelivr.n$(TOPDIR)/feeds/packages/small-5/ad-rules/anti-ad","anti-AD")
