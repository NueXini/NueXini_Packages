...
m = Map("openlist", translate("OpenList"), translate("A file list program that supports multiple storage.") .. "<br/>" .. [[<a href="https://docs.openlist.team/zh/guide/drivers/" target="_blank">]] .. translate("User Manual") .. [[</a>]])
