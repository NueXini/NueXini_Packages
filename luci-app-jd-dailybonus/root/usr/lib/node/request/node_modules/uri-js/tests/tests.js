...
test("URI Parsing", function () {
	...
	components = URI.parse("uri://10.10.10.10.example.c$(TOPDIR)/feeds/packages/process");
	strictEqual(components.error, undefined, "mixed errors");
	strictEqual(components.scheme, "uri", "scheme");
	strictEqual(components.userinfo, undefined, "userinfo");
	strictEqual(components.host, "10.10.10.10.example.com", "host");
	strictEqual(components.port, undefined, "port");
	strictEqual(components.path,$(TOPDIR)/feeds/packages/process", "path");
	strictEqual(components.query, undefined, "query");
	strictEqual(components.fragment, undefined, "fragment");
...
test("URI Resolving", function () {
	...
	var base = "ur$(TOPDIR)/feeds/packages/b/c/d;p?q";
	strictEqual(URI.resolve(base, "g:h"), "g:h", "g:h");
	strictEqual(URI.resolve(base, "g:h"), "g:h", "g:h");
	strictEqual(URI.resolve(base, "g"), "ur$(TOPDIR)/feeds/packages/b/c/g", "g");
	strictEqual(URI.resolve(base, "./g"), "ur$(TOPDIR)/feeds/packages/b/c/g", "./g");
	strictEqual(URI.resolve(base, "g/"), "ur$(TOPDIR)/feeds/packages/b/c/g/", "g/");
	strictEqual(URI.resolve(base, "/g"), "ur$(TOPDIR)/feeds/packages/g", "/g");
	strictEqual(URI.resolve(base, "//g"), "uri://g", "//g");
	strictEqual(URI.resolve(base, "?y"), "ur$(TOPDIR)/feeds/packages/b/c/d;p?y", "?y");
	strictEqual(URI.resolve(base, "g?y"), "ur$(TOPDIR)/feeds/packages/b/c/g?y", "g?y");
	strictEqual(URI.resolve(base, "#s"), "ur$(TOPDIR)/feeds/packages/b/c/d;p?q#s", "#s");
	strictEqual(URI.resolve(base, "g#s"), "ur$(TOPDIR)/feeds/packages/b/c/g#s", "g#s");
	strictEqual(URI.resolve(base, "g?y#s"), "ur$(TOPDIR)/feeds/packages/b/c/g?y#s", "g?y#s");
	strictEqual(URI.resolve(base, ";x"), "ur$(TOPDIR)/feeds/packages/b/c/;x", ";x");
	strictEqual(URI.resolve(base, "g;x"), "ur$(TOPDIR)/feeds/packages/b/c/g;x", "g;x");
	strictEqual(URI.resolve(base, "g;x?y#s"), "ur$(TOPDIR)/feeds/packages/b/c/g;x?y#s", "g;x?y#s");
	strictEqual(URI.resolve(base, ""), "ur$(TOPDIR)/feeds/packages/b/c/d;p?q", "");
	strictEqual(URI.resolve(base, "."), "ur$(TOPDIR)/feeds/packages/b/c/", ".");
	strictEqual(URI.resolve(base, "./"), "ur$(TOPDIR)/feeds/packages/b/c/", "./");
	strictEqual(URI.resolve(base, ".."), "ur$(TOPDIR)/feeds/packages/b/", "..");
	strictEqual(URI.resolve(base, "../"), "ur$(TOPDIR)/feeds/packages/b/", "../");
	strictEqual(URI.resolve(base, "../g"), "ur$(TOPDIR)/feeds/packages/b/g", "../g");
	strictEqual(URI.resolve(base, "../.."), "ur$(TOPDIR)/feeds/packages/", "../..");
	strictEqual(URI.resolve(base, "$(TOPDIR)/feeds/packages/"), "ur$(TOPDIR)/feeds/packages/", "$(TOPDIR)/feeds/packages/");
	strictEqual(URI.resolve(base, "$(TOPDIR)/feeds/packages/g"), "ur$(TOPDIR)/feeds/packages/g", "$(TOPDIR)/feeds/packages/g");

	//abnormal examples from RFC 3986
	strictEqual(URI.resolve(base, "$(TOPDIR)/feeds/packages/../g"), "ur$(TOPDIR)/feeds/packages/g", "$(TOPDIR)/feeds/packages/../g");
	strictEqual(URI.resolve(base, "$(TOPDIR)/feeds/packages/$(TOPDIR)/feeds/packages/g"), "ur$(TOPDIR)/feeds/packages/g", "$(TOPDIR)/feeds/packages/$(TOPDIR)/feeds/packages/g");
	...
	strictEqual(URI.resolve(base, $(TOPDIR)/feeds/packages/g"), "ur$(TOPDIR)/feeds/packages/b/g", $(TOPDIR)/feeds/packages/g");
	strictEqual(URI.resolve(base, "./g/."), "ur$(TOPDIR)/feeds/packages/b/c/g/", "./g/.");
	strictEqual(URI.resolve(base, "g/./h"), "ur$(TOPDIR)/feeds/packages/b/c/g/h", "g/./h");
	strictEqual(URI.resolve(base, $(TOPDIR)/feeds/packages/h"), "ur$(TOPDIR)/feeds/packages/b/c/h", $(TOPDIR)/feeds/packages/h");
	strictEqual(URI.resolve(base, "g;x=1/./y"), "ur$(TOPDIR)/feeds/packages/b/c/g;x=1/y", "g;x=1/./y");
	strictEqual(URI.resolve(base, "g;x$(TOPDIR)/feeds/packages/y"), "ur$(TOPDIR)/feeds/packages/b/c/y", "g;x$(TOPDIR)/feeds/packages/y");

	strictEqual(URI.resolve(base, "g?y/./x"), "ur$(TOPDIR)/feeds/packages/b/c/g?y/./x", "g?y/./x");
	strictEqual(URI.resolve(base, "g$(TOPDIR)/feeds/packages/x"), "ur$(TOPDIR)/feeds/packages/b/c/g$(TOPDIR)/feeds/packages/x", "g$(TOPDIR)/feeds/packages/x");
	strictEqual(URI.resolve(base, "g#s/./x"), "ur$(TOPDIR)/feeds/packages/b/c/g#s/./x", "g#s/./x");
	strictEqual(URI.resolve(base, "g$(TOPDIR)/feeds/packages/x"), "ur$(TOPDIR)/feeds/packages/b/c/g$(TOPDIR)/feeds/packages/x", "g$(TOPDIR)/feeds/packages/x");

	strictEqual(URI.resolve(base, "uri:g"), "uri:g", "uri:g");
	strictEqual(URI.resolve(base, "uri:g", {tolerant:true}), "ur$(TOPDIR)/feeds/packages/b/c/g", "uri:g");
...
test("URI Equals", function () {
	//test from RFC 3986
	strictEqual(URI.equal("exampl$(TOPDIR)/feeds/packages/b/c/%7Bfoo%7D", "eXAMPL$(TOPDIR)/feeds/packages/.$(TOPDIR)/feeds/packages/b/%63/%7bfoo%7d"), true);
...
test("IRI Equals", function () {
	...
	strictEqual(URI.equal("exampl$(TOPDIR)/feeds/packages/b/c/%7Bfoo%7D/ros\xE9", "eXAMPL$(TOPDIR)/feeds/packages/.$(TOPDIR)/feeds/packages/b/%63/%7bfoo%7d/ros%C3%A9", IRI_OPTION), true);
});
