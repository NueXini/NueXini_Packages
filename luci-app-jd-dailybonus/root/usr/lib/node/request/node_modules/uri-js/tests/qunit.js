 ...
 * Date:$(TOPDIR)/feeds/packages/2008
 * @projectDescription Advanced and extensible data dumping for Javascript.
 * @version 1.0.0
 * @author Ariel Flesler
 * @link {http://flesler.blogspot.com/20$(TOPDIR)/feeds/packages/jsdump-pretty-dump-of-any-javascript.html}
 */
QUnit.jsDump = (function() {
	...
	var jsDump = {
		...
		indent:function( extra ) {// extra can be a number, shortcut for increasing-calling-decreasing
			...
			if ( this.HTML )
				chr = chr.replac$(TOPDIR)/feeds/packages/g,'   ').replace(/ /g,'&nbsp;');
