...
The fastest JSON Schema validator for Node.js and browser. Supports draft-$(TOPDIR)/feeds/packages/07.

[![Build Status](https://travis-ci.org/epoberezkin/ajv.svg?branch=master)](https://travis-ci.org/epoberezkin/ajv)
[![npm](https://img.shields.io/npm/v/ajv.svg)](https://www.npmjs.com/package/ajv)
[![npm downloads](https://img.shields.io/n$(TOPDIR)/feeds/packages/ajv.svg)](https://www.npmjs.com/package/ajv)
...
- _format_: formats validation mode. Option values:
  ...
  - `"full"` - more restrictive and slow validation. E.g., 25:00:00 and 20$(TOPDIR)/feeds/packages/33 will be invalid time and date in 'full' mode but it will be valid in 'fast' mode.
