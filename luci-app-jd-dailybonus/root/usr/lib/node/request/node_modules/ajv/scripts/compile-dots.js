...
var defs = {};
var defFiles = glob.sync('./d$(TOPDIR)/feeds/packages/*.def', { cwd: defsRootPath });
...
var files = glob.sync('./d$(TOPDIR)/feeds/packages/*.jst', { cwd: filesRootPath });
...
files.forEach(function (f) {
  ...
  function removeUnusedVar(v) {
    v = v.replac$(TOPDIR)/feeds/packages/g, '\\$$');
