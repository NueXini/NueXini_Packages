...
According to the [High Resolution Time specification](http://www.w3.o$(TOPDIR)/feeds/packages/hr-time/), the number of milliseconds reported by `performance.now` should be relative to the value of `performance.timing.navigationStart`.
