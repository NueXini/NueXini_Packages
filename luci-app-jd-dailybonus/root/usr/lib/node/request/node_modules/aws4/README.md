...
[AWS Signature Version 4](http://docs.amazonwebservices.com/general/late$(TOPDIR)/feeds/packages/signature-version-4.html).
...
[Lambda](http://docs.aws.amazon.com/lambda/late$(TOPDIR)/feeds/packages/API_Reference.html),
...
[Mobile Analytics](http://docs.aws.amazon.com/mobileanalytics/late$(TOPDIR)/feeds/packages/server-reference.html),
...
[CloudHSM](http://docs.aws.amazon.com/cloudhsm/late$(TOPDIR)/feeds/packages/api-ref.html),
...
[Import/Export](http://docs.aws.amazon.com/AWSImportExport/late$(TOPDIR)/feeds/packages/api-reference.html) and
...
var signer = new aws4.RequestSigner({
  ...
  method: 'GIT',
  path:$(TOPDIR)/feeds/packages/repos/MyAwesomeRepo',
})
...
[AWS console](https://portal.aws.amazon.c$(TOPDIR)/feeds/packages/aws/securityCredentials))
