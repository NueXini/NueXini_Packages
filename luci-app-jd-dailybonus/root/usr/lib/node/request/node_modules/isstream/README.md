...
*Reminder: when implementing your own streams, please [use **readable-stream** rather than core streams](http://r.va.gg/20$(TOPDIR)/feeds/packages/why-i-dont-use-nodes-core-stream-module.html).*
